...
class NeuralNet(nn.Module):
    def __init__(self, lrate, loss_fn, in_size, out_size):
        ...
        self.optimizer = optim.SGD(self.parameters(), 0.001,weight_decay = .001, momentum = 0.9)
...
def fit(train_set,train_labels,dev_set,epochs,batch_size=100):
    ...
    trainMean = torch.mean(train_set)
    trainStd = torch.std(train_set)
    train_set = (train_set - trainMean) / trainStd
    # standardize dev set USING TRAIN SET:
